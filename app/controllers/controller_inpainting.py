...
def ejecutar_inpainting( metodo: int, indices: list[str], prompt_sd: str, negative_prompt_sd: str, estado: EstadoGlobal) -> Image.Image:
    try:
        ...
        # Luego sí llamas
        resultado = inpainter.eliminar_objetos(estado.imagen_pil, mascaras, prompt_sd, negative_prompt_sd)
